...
function SimpleMapD3(o) {
  ...
  smd.brewer = {
    ...
    // sequential
    myBlue : ['#4682b4','#4e8abc','#5592c3','#5c9bcb','#63a3d3','#6aacda','#72b4e2','#79bdea','#80c5f2','#87cefa'], // my colorset ; https://gka.github.io/palettes/#colors=lightyellow,orange,deeppink,darkred|steps=7|bez=1|coL=1 ; http://colorbrewer2.org/#type=qualitative&scheme=Accent&n=3
    //
  ...
  smd.projection = function() {
    ...
    smd.projection = d3.geo[projFunc]()
      .scale(1000)
      .translate([smd.width / 2.5, smd.height / 2]);
